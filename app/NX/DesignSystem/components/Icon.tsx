...
import ForgetIcon from '@mui/icons-material/PersonRemoveOutlined';
...
import QueueIcon from '@mui/icons-material/AutoMode';
...
export default function Icon({ icon, color }: I_Icon) {
  ...
  switch (icon) {
    ...
    case 'random':
      ...
      break;
      case 'flag':
      iconFragment = <FlagIcon color={color} />;
      break;
    case 'archive':
      iconFragment = <ArchiveIcon color={color} />;
      break;
    case 'queue':
      iconFragment = <QueueIcon color={color} />;
      break;
    case 'hammer':
